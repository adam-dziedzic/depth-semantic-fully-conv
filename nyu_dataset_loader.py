...
class ListDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        input_im, target_depth_im, target_label_im = imread(
        ...
        if self.co_transform is not None:
            input_im, target_depth_im, target_label_im = self.co_transform(
                input_im, target_depth_im, target_label_im)
        ...
        input_depth_im = torch.cat(
            (target_depth_im, target_depth_im, target_depth_im), dim=0)
